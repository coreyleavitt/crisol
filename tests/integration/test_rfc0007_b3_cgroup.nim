...
import std/[unittest, os, options, osproc, monotimes, times]
...
when defined(linux):
  ...
  echo "test_rfc0007_b3_cgroup: skipped (cgroup delegation is linux-only; inert everywhere except the CI cgroup leg)"
