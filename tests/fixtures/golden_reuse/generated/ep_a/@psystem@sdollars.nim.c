...
/* Command for C compiler:
   gcc -c  -w -fmax-errors=3 -fno-strict-aliasing -pthread -I/workspace/tests/fixtures/golden_reuse/include   -I/opt/nim/2.2.10-patched/lib -I/workspace/tests/fixtures/golden_reuse -o /workspace/tests/fixtures/golden_reuse/generated/ep_a/@psystem@sdollars.nim.c.o /workspace/tests/fixtures/golden_reuse/generated/ep_a/@psystem@sdollars.nim.c */
...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, dollar___systemZdollars_u34)(NI64 xX60gensym4__p0) {
	NimStringV2 result;
	nimfr_("$", "/opt/nim/2.2.10-patched/lib/system/dollars.nim");
	nimlf_(20, "/opt/nim/2.2.10-patched/lib/system/dollars.nim");	result = TM__n49a9aYp5BrbXv9a6OCpJYm0g_3;
